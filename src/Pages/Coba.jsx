...
function Maps() {
  ...
  const facilityGroups = {
    ...
    "Kamar Mandi": [
      'shower', 'kloset duduk', 'bathtub', 'wastafel', 'bak mandi', 
      'ember mandi', 'kloset jongkok', 'kamar mandi dalam', 'kamar mandi luar'
    ],
    "Keamanan": [
  ...
  const allFacilities = [...new Set(
    Object.values(facilityGroups).flat()
  )].sort();
                ...
                <div>
                    ...
                    <div className="bg-white shadow-md rounded-xl flex items-center w-full mb-4">
                      ...
                      <div className="ml-3 mb-2">
                        ...
                        <p className="text-2xl font-bold text-gray-900">
                          Rp{(predictionResult.prediksi_harga).toLocaleString("id-ID")}{" "}
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-md mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleBudgetParamChange("latitude", parseFloat(e.target.value))}
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleBudgetParamChange("longitude", parseFloat(e.target.value))}
                        />
                      </div>
                    </div>
                    <div>
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleBudgetParamChange("panjang", e.target.value)}
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleBudgetParamChange("lebar", e.target.value)}
                        />
                      </div>
                    </div>
                        ...
                        {Object.entries(facilityGroups).map(([groupName, facilities]) => (
                          <div key={groupName} className="mb-2">
                            <div 
                              ...
                              onClick={() => setOpenFacilityGroup(openFacilityGroup === groupName ? null : groupName)}
                            >
                              <span className="text-xs font-medium">{groupName}</span>
                              <ChevronDown 
                                className={`w-3 h-3 transition-transform ${
                                  openFacilityGroup === groupName ? "rotate-180" : "rotate-0"
                                }`}
                              />
                            </div>
                                ...
                                {facilities.map(facility => (
                                  <label key={facility} className="flex items-center text-xs">
                                    <input
                                      type="checkbox"
                                      className="mr-1"
                                      checked={budgetParams.fasilitas.includes(facility)}
                                      onChange={() => handleBudgetParamChange("fasilitas", facility)}
                                    />
                                    {facility}
                                  </label>
                                ))}
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      ...
                      <button 
                        onClick={() => setBudgetParams(prev => ({...prev, fasilitas: []}))}
                      ...
                      {kostList.map((kost, index) => (
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-500">
                            Rp{Number(kost.data.harga_sewa).toLocaleString("id-ID")}/bulan
                          </p>
                          <button
                            onClick={() => (window.location.href = `/detail/${kost.data.id_kost}`)}
