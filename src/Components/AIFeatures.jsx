...
function AIFeatures({ budgetParams, setBudgetParams, fullAddress }) {
  ...
  return (
    <div className="fixed top-24 right-2 z-50 flex items-center space-x-2">
      ...
      {isOpen && (
        <div className="w-[90%] max-w-[450px] h-[90vh] max-h-[500px] bg-[#ECF0F1] shadow-lg rounded-lg flex flex-col fixed top-36 sm:right-14 z-50 border border-gray-300 sm:w-[450px] sm:h-[500px] sm:max-h-[500px] sm:max-w-[450px] sm:top-38">
